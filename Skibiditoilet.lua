...
InfoTab:AddParagraph({ "Owner / Developer:", "Hanzo." })
InfoTab:AddParagraph({ "Colaborações:", "" })
InfoTab:AddParagraph({ "Você está usando:", "Hanzo Hub Brookhaven " })
...
om/SAZXHUB/Control-update/main/README.md", true))()
    end
})
